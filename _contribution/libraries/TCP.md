...
TCP is a protocol used to exchange messages over a network. TCP is used to receive events from the Discord API's Gateway (WebSocket Connection). Disgo uses a `nhooyr/websocket` fork to manage TCP connections.
