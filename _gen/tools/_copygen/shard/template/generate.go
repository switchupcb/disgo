...
func generateComment(function *models.Function) string {
	return "// SendEvents sends an Opcode " + function.Options.Custom["opcode"][0] + " " + function.Name + " event to the Discord Gateway."
}

// generateSignature generates a function's signature.
func generateSignature(function *models.Function) string {
	return "func (c " + function.From[0].Field.FullDefinition() + ") SendEvents(bot *Client, sm ShardManager) (" +
